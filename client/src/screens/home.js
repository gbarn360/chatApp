    ...
    <div className='container'>
      ...
      <div className='chatBox'>
        ...
        <div id="manageGroupModal" className="manageGroupModal">
          ...
          <div className='list'>
            {onlineUsers.filter(users => users.user != location.state.name).map((user, index) => (<div className='displayUser'><input type="checkbox" id="checkboxUser" name={user.user} /><p style={{ padding: "5px", color: "#d4d4d4" }} >{user.user}</p></div>))}
            {offlineUsers.map((user, index) => (<div className='displayUser'><input type="checkbox" name={user.user} /><p style={{ padding: "5px", color: "#d4d4d4" }} >{user.user}</p></div>))}
          </div>
